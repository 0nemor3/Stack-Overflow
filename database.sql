...
VALUES ("How do I undo 'git add' before commit ?", "I mistakenly added files to git using the command 'git add'.\r Is there a way to undo this ?", '2021-04-16 15:17:05', "Jean Monet", 2, 0);
